...
enum LegalURLs {
    ...
    /// Page Plan Pro (SPA `/paiement`) — en mode embed app iOS (sans bouton retour web).
    static let merchantSaasProPaymentPage = URL(string: "https://myfidpass.fr/paiement?app_embed=1")!
