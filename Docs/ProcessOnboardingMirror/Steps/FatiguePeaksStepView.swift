//
//  FatiguePeaksStepView.swift
//  Process
//
//  Vue pour identifier les pics de fatigue
//

import SwiftUI

struct FatiguePeaksStepView: View {
    ...
    var body: some View {
        GeometryReader { geometry in
            ZStack {
                ...
                VStack {
                    OnboardingTitleView("À quel moment", "as-tu des pics de fatigue ?")
        ...
        .onAppear {
            onValidationChanged?(!selectedPeaks.isEmpty)
        }
}
}
